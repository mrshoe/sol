...
sceneObjects = [
    (Sphere "red" (Vector3 4 1 (-1.5)) 1),
    (Sphere "red" (Vector3 2 1 1.5) 1),
    (Triangle "blue" (Vector3 0 0 (-3)) (Vector3 6 0 (-3)) (Vector3 0 6 (-3)) zaxis zaxis zaxis), -- side
    (Triangle "blue" (Vector3 6 6 (-3)) (Vector3 6 0 (-3)) (Vector3 0 6 (-3)) zaxis zaxis zaxis),
    ...
    (Triangle "blue" (Vector3 0 0 (-3)) (Vector3 0 0 3) (Vector3 6 0 3) yaxis yaxis yaxis), -- floor
    (Triangle "blue" (Vector3 0 0 (-3)) (Vector3 6 0 (-3)) (Vector3 6 0 3) yaxis yaxis yaxis),
    (Triangle "blue" (Vector3 0 6 (-3)) (Vector3 0 6 3) (Vector3 6 6 3) (Vector3 0 (-1) 0) (Vector3 0 (-1) 0) (Vector3 0 (-1) 0)), -- ceiling
    (Triangle "blue" (Vector3 0 6 (-3)) (Vector3 6 6 (-3)) (Vector3 6 6 3) (Vector3 0 (-1) 0) (Vector3 0 (-1) 0) (Vector3 0 (-1) 0)),
    (Triangle "blue" (Vector3 6 0 (-3)) (Vector3 6 0 3) (Vector3 6 6 3) (Vector3 (-1) 0 0) (Vector3 (-1) 0 0) (Vector3 (-1) 0 0)), -- back
    (Triangle "blue" (Vector3 6 0 (-3)) (Vector3 6 6 (-3)) (Vector3 6 6 3) (Vector3 (-1) 0 0) (Vector3 (-1) 0 0) (Vector3 (-1) 0 0))
    ]

sceneLights = [PointLight 200 (Vector3 3 5 0) (Vector3 1 1 1)
              ]
...
sceneShadeLight depth (HitInfo dist p n (Material rgbcolor))
                light@(PointLight wattage lightpos lightcolor) =
    (rgbcolor >* (diffuse / lightFalloff)) >+ specularColor
    where
        diffuse = if shadowRay then 0 else n >. (norm toLight)
        toLight = lightpos >- p
